...
import paymentSystemOO.Schedule;
...
public abstract class PaymentSchedules {
	...
	public static Employee[] chooseSchedule(Employee list1[], Schedule list2[], int month)
	{
		int choice;
		int i,id;
		int aux;
                ...
                switch(list2[choice].getSchedule_type())
                {
                    ...
                    case 2:
                        if(list1[id] instanceof Salaried)
                        {
                            ...
                            {
                                ( (Salaried)list1[id]).setPayment_date(UtilityFunctions.dayUtil(month));
