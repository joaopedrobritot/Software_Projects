...
public class EmployeeRelated {
	...
	public Employee addEmployee(Employee new_employee, ExtraFunctions extra_func, UndoRedo system_state, int id, int month)
	{
		int choice;
	...
	public Employee[] changeDetails(Employee list[], ExtraFunctions extra_func, UndoRedo system_state, int month)
	{
		Employee new_type;
		int i;
		while(true)
                ...
                case 3:
                	while(true)
                	{
                        ...
                        else if(given == 2)
                        {
                			...
                			( (Salaried) new_type).setPayment_date(extra_func.dayUtil(month));
